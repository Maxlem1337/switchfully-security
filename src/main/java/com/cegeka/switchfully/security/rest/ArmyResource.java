...
//    @PreAuthorize("hasAnyAuthority('GENERAL', 'PRIVATE')")
    @PreAuthorize("hasAuthority('GETDEPLOYEDARMYINFO')")
...
//    @PreAuthorize("hasAuthority('CIVILIAN')")
    @PreAuthorize("hasAuthority('JOINARMY')")
...
//    @PreAuthorize("hasAuthority('HUMAN_RELATIONSHIPS')")
    @PreAuthorize("hasAuthority('PROMOTEPRIVATE')")
...
//    @PreAuthorize("hasAuthority('HUMAN_RELATIONSHIPS')")
    @PreAuthorize("hasAuthority('DISCHARGESOLDIER')")
...
//    @PreAuthorize("hasAuthority('GENERAL')")
    @PreAuthorize("hasAuthority('LAUNCHNUKES')")
